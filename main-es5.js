...
var TaskComponent = /** @class */ (function () {
    function TaskComponent(taskServ, toastr, userServ, router) {
    ...
    TaskComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.userServ.getUsers().subscribe(function (user) {
            _this.users = [];
    ...
    TaskComponent.prototype.onSubmit = function () {
        var _this = this;
        this.updatedTask = {
            id: this.id,
            name: this.taskName,
        ...
        this.taskServ.updateTask(this.id, this.updatedTask).subscribe(function (res) {
    ...
    TaskComponent.prototype.sendTask = function (id) {
        ...
        if (id == 0) {
            ...
            setTimeout(function () { _this.notShareTask = false; }, 3000);
        }
        else {
            this.idUser = id;
            var Task = {
...
var environment = {
    production: false,
    API_URL: "..\db.json",
    API_URL1: "D:\ManagerTask\TaskManager\Без названия.png"
};
/*
...
var AddTaskModule = /** @class */ (function () {
...
var AllTaskModule = /** @class */ (function () {
    function AllTaskModule() {
    }
...
var AddTaskComponent = /** @class */ (function () {
    function AddTaskComponent(taskServ, toastr, router) {
        this.taskServ = taskServ;
        this.toastr = toastr;
        this.router = router;
        this.myGroup = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
    ...
    AddTaskComponent.prototype.onSubmit = function () {
        var _this = this;
        var value = this.myGroup.value;
        this.creatTask = {
            name: value.name,
            description: value.description,
            userId: (JSON.parse(localStorage.getItem("user"))).id
        };
        this.taskServ.createTask(this.creatTask).subscribe(function (res) {
            _this.toastr.success('Created');
            _this.router.navigate(['/mytasks']);
        }, function (err) {
            _this.error = err.message;
            _this.toastr.error("" + _this.error);
...
var AllTaskComponent = /** @class */ (function () {
    function AllTaskComponent(taskSer, router) {
    ...
    AllTaskComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.taskSer.getTasks(this.currentUserId).subscribe(function (task) {
            _this.tasks = [];
    ...
    AllTaskComponent.ctorParameters = function () { return [
...
var HomepageComponent = /** @class */ (function () {
    function HomepageComponent(taskSer) {
        this.taskSer = taskSer;
        this.currentUser = JSON.parse(localStorage.getItem("user"));
        this.currentUserId = this.currentUser.id;
        this.tasks = [];
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(userServ, router, toastr) {
        this.userServ = userServ;
        this.router = router;
        this.toastr = toastr;
        this.myGroup = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
    ...
    LoginComponent.prototype.onSubmit = function () {
        var _this = this;
        var value = this.myGroup.value;
        this.userServ.getUserByEmail(value.email, value.password).subscribe(function (user) {
            var userEmail = '';
            var userPassword = '';
            if (user) {
                user.forEach(function (item) {
                ...
                if (userPassword == value.password && userEmail == value.email) {
                    ...
                    setTimeout(function () { return _this.showMessage = false; }, 3000);
                }
            }
        }, function (err) {
            _this.error = err.message;
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(userServ, router, toastr) {
        this.userServ = userServ;
        this.router = router;
        this.toastr = toastr;
    ...
    RegisterComponent.prototype.onSubmit = function () {
        ...
        this.userServ.createUser(user).subscribe(function (user) {
