...
var NewFormComponent = /** @class */ (function () {
    function NewFormComponent(formBuilder, formService, toastr) {
    ...
    NewFormComponent.prototype.deleteField = function (deletingField) {
        this.formFields = this.formFields.filter(function (field) {
            return field.name != deletingField.name;
        });
    };
    NewFormComponent.prototype.saveForm = function () {
        var _this = this;
        var fieldInfo = {
        ...
        this.formService.createForm(this.newForm).subscribe(function (res) {
            _this.formFields = [];
            _this.toastr.success('Form ' + fieldInfo.title + 'was created');
        }, function (err) {
            _this.toastr.error('Try create form one more time');
        });
    };
