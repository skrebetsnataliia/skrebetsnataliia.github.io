...
var FormDetailsModule = /** @class */ (function () {
    function FormDetailsModule() {
    }
...
var FormDetailsComponent = /** @class */ (function () {
    function FormDetailsComponent(store, fb) {
        this.store = store;
        this.fb = fb;
    ...
    FormDetailsComponent.prototype.ngOnInit = function () {
        ...
        var form$ = this.store.select(_store_reducers_form_reducer__WEBPACK_IMPORTED_MODULE_4__["getCurrentForm"]);
        ...
        this.formDetails = this.fb.group({
            ...
            form$.subscribe(function (currentForm) {
                if (currentForm) {
                    _this.formDetails.patchValue({
    ...
    FormDetailsComponent.prototype.showDetails = function (item) {
        var openedForm = {
            name: item.name,
    ...
    FormDetailsComponent.prototype.editForm = function (item) {
        var openedForm = {
            name: item.name,
            background: item.background,
            id: item.id,
    ...
    FormDetailsComponent.prototype.updateForm = function () {
        var e_1, _a;
        var updatedForm = {
        ...
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.currentForm.fields), _c = _b.next(); !_c.done; _c = _b.next()) {
                var key = _c.value;
    ...
    FormDetailsComponent.prototype.deleteForm = function (item) {
        this.store.dispatch(new _store_actions_myform_action__WEBPACK_IMPORTED_MODULE_3__["DeleteForm"](item.id));
    };
    FormDetailsComponent.prototype.addField = function () {
        this.newField = !this.newField;
    };
    FormDetailsComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=src-modules-form-details-form-details-module-es5.js.map